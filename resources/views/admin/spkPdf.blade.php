            ...
            <tbody>
                <tr style="height:20px;">
                    ...
                    <td
                        ...
                        rowspan="5">
                        <nobr>
                          <img src="{{asset('image/'.$partner->foto_partner)}}" alt="{{$partner->foto_partner}}" width="180" height="90">
                        </nobr>
                    </td>
                </tr>
                ...
                <tr style="height:20px;">
                    <td
                        ...
                        rowspan="8">
                        <nobr>
                          <img src="{{asset('image/'.$tampilPdf->foto_1)}}" alt="{{$tampilPdf->foto_1}}" width="300" height="150">
                        </nobr>
                    </td>
                    <td
                        style="font-family:Calibri;text-align:center;font-size:11px;background-color:#fff;color:#000000;font-weight:bold;border:1px solid;border-left-color:#000000;border-right-color:#000000;border-top-color:#000000;border-bottom-color:#000000;min-width:50px"
                        ...
                        rowspan="8">
                        <nobr>
                          <img src="{{asset('image/'.$tampilPdf->foto_2)}}" alt="{{$tampilPdf->foto_2}}" width="300" height="150">
                        </nobr>
                    </td>
                </tr>
                <tr style="height:20px;"></tr>
